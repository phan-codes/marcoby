...
const Partners2 = () => {
	return (
		<div className="flex overflow-hidden group">
			<div className="flex min-w-full justify-around items-center py-5 px-2 gap-x-6 animate-slideRight group-hover:paused">
				<a href="https://www.atlassian.com/" className="inline-block max-w-none" target="_blank">
					<img src={ninjaone} alt=" wolf gordon" width={150} height={70} />
				</a>
				<a href="https://www.fortinet.com/" className="inline-block max-w-none" target="_blank">
					<img src={nordpass} alt=" wolf gordon" width={150} height={70} />
				</a>
				<a href="https://www.atlassian.com/" className="inline-block max-w-none" target="_blank">
					<img src={paypal} alt=" wolf gordon" width={150} height={70} />
				</a>
				<a href="https://www.atlassian.com/" className="inline-block max-w-none" target="_blank">
					<img src={sentinelone} alt=" wolf gordon" width={150} height={70} />
				</a>
				<a href="https://www.atlassian.com/" className="inline-block max-w-none" target="_blank">
					<img src={stripe} alt=" wolf gordon" width={150} height={70} />
				</a>
			</div>

			{/* Duplicate */}

			<div className="flex min-w-full justify-around items-center py-3 px-2 gap-x-6 animate-slideRight group-hover:paused">
				<a href="https://www.atlassian.com/" className="inline-block max-w-none" target="_blank">
					<img src={ninjaone} alt=" wolf gordon" width={150} height={70} />
				</a>
				<a href="https://www.fortinet.com/" className="inline-block max-w-none" target="_blank">
